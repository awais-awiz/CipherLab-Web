...
export default function DocsLayout({ activeSection, setActiveSection, children }) {
  return (
    <SidebarProvider>
      <div className="min-h-screen flex flex-col w-full bg-slate-50 dark:bg-slate-950 overflow-x-hidden">
        <div className="flex flex-1">
          ...
          <main className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex-1 overflow-x-auto px-4 md:px-6 py-6 w-full max-w-full">
